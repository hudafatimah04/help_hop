...
class _RescuerHomeScreenState extends State<RescuerHomeScreen> {
  ...
  final List<SosRequest> _requests = [
    const SosRequest(
      id: '1',
      name: 'Fatimah',
      emergencyType: 'Flood',
      medicalInfo: 'Diabetic, may need insulin',
      latitude: 12.9716,
      longitude: 77.5946,
      approxDistance: '250 m',
    ),
    const SosRequest(
      id: '2',
      name: 'Unknown',
      emergencyType: 'Earthquake',
      medicalInfo: 'Unconscious, bleeding',
      latitude: 12.9680,
      longitude: 77.5920,
      approxDistance: '800 m',
    ),
    const SosRequest(
      id: '3',
      name: 'Priya',
      emergencyType: 'Fire',
      medicalInfo: 'Asthmatic, smoke inhalation',
      latitude: 12.9730,
      longitude: 77.5980,
      approxDistance: '1.2 km',
    ),
  ];
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text(
                      'Approx. distance: ${sos.approxDistance}\nTap to view & accept',
                    ),
                    isThreeLine: true,
...
class _RescuerSosDetailScreenState extends State<RescuerSosDetailScreen> {
  ...
  // Dummy rescuer location (for demo)
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'Medical: ${sos.medicalInfo}',
            ),
            const SizedBox(height: 8),
            Text('Approx. distance: ${sos.approxDistance}'),
            const SizedBox(height: 16),
            Text(
...
class _SOSScreenState extends State<SOSScreen> {
  ...
  Future<void> _sendSOS(String emergencyType) async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('SOS sent successfully (offline mode active)\nType: $emergencyType'),
          backgroundColor: Colors.green,
          duration: const Duration(seconds: 3),
        ),
      );
